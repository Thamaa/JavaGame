...
public class Lluvia implements Interface {
    ...
    public static Lluvia getInstance(Piezas gotaBuena, Texture gotaMala, Poderes poderes, Texture gotaCurativa, Texture gotaFatal, Sound ss, Music mm) {
        if (instance == null) {
            instance = new Lluvia(gotaBuena, gotaMala, poderes, gotaCurativa, gotaFatal, ss, mm);
        }
        return instance;
    }
